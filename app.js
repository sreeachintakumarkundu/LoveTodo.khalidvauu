...
const getTodos=()=>{
    ...
    todos.forEach((todo,index) =>{
        ...
        <li class= "sTudo">
            <span>${todo.text}</span> 
             <div class="icons">
                <img  class="editTodos" src="mycollection/png/001-document-editor.png" alt="" data-id=${index}>
                 <img class="deleteTodo" src="mycollection/png/003-delete.png" alt="" data-id=${index}>        
             </div>
          </li>
